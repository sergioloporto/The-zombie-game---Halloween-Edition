...
var playShootingSound = function playShootingSound(volume) {
...
var login = function login() {
  ...
  playBtn.addEventListener('click', function (e) {
    ...
    var playZombieSound = function playZombieSound(volumeValue) {
...
function zombieGame() {
  ...
  var countTheShots = function countTheShots() {
    var shotsNumber = document.querySelector('.shots');
    shotsNumber.innerText = "".concat(killed, "/").concat(shotsCounter);
    window.addEventListener('click', function () {
      shotsCounter++;
